...
# saved as plotprofiler_computematrix_up.sh in /researchers/krutika.ambani/Goel_lab_members/Cath_Dietrich/20230125_CP_ATAC_MCF7M_CDK2i/R_analysis/4.diffbind_overcome_resistance/paper_figures/scripts
...
-b 1000 -a 1000 \
-R $BED_dir/ParLY_vs_ParDMSO_up.bed \
...
--sortRegions descend \
-p 14 \
-o $output_dir/PAR_LYvsDMSO_peaks_overcomeresist_up_PAR.gz
...
--sortRegions descend \
-p 14 \
-o $output_dir/PAR_LYvsDMSO_peaks_overcomeresist_up_LYR.gz
...
--sortRegions descend \
-p 14 \
-o $output_dir/PAR_LYvsDMSO_peaks_overcomeresist_up_LYFR.gz
